...
namespace ATypeStates
{
    ...
    {
        public override void Enter(AType entity){entity.SetAnimation(entity.CurrentType); entity.LookPlayer(); }
        public override void Execute(AType entity){ }
        public override void Exit(AType entity) { entity.LookOriginal(); }
    }
