...
public class EyePenaltyGroup : MonoBehaviour
{
    ...
    public EyePenaltyObject ActiveEyePenaltyObject(){
        if(Random.Range(0, 2) == 0){
            ...
            // 바닥에 있는 경우 플레이어 머리(카메라)를 중심으로 잡는 경우가 더 자연스러움
            eyePenaltyObject_Bottom.SetPlayerTransform(eyePenaltyManager.cameraTransform);
            eyePenaltyObject_Bottom.LookPlayerTransform();
            ...
            eyePenaltyObject_Top.LookPlayerTransform();
