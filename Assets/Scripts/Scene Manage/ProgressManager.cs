...
public class ProgressManager : MonoBehaviour
{
    ...
    public SortedDictionary<int, string> checkListStr = new SortedDictionary<int, string>{
        ...
        {104, "다음 동으로 넘어가세요."},
        {105, "3-6열쇠를 찾으세요."},
        {106, "3-6에서 교무실 열쇠를 얻으세요. "},
        {107, "3학년 교무실에서 남은 교실들의 열쇠를 얻으세요."},
        {108, "교실동으로 돌아가 3학년 교실들을 구석구석, 꼼꼼히 탐방하세요."},
        {109, "2층에서 사용할 교실 열쇠 조각을 찾으세요. (1)"},
        {110, "2층에서 사용할 교실 열쇠 조각을 찾으세요. (2)"},
        {111, "2층에서 사용할 교실 열쇠 조각을 찾으세요. (3)"},
        
        {201, "교실동 2층 복도의 학생회장과 대화하세요."},
        // {202, "전체 책자를 확인하세요."},
        {203, "2-1에서 무서운 학생들과 대화하세요."},
        {204, "빵을 구매하세요."},
        {205, "2학년 교무실에서 교실 열쇠를 훔치세요."},
        {206, "남은 2학년 교실들을 구석구석, 꼼꼼히 탐방하세요."},
        {207, "학생회실 열쇠 조각을 찾으세요. (1)"},
        {208, "학생회실 열쇠 조각을 찾으세요. (2)"},
        {209, "학생회실 열쇠 조각을 찾으세요. (3)"},
        {210, "학생회실에서 방송실 장비 비밀번호를 얻으세요."},
        {301, "보건실에서 약을 구하세요."},

        {211, "과학실에서 멍이 든 학생과 대화하세요."},
        {302, "멍이 든 학생에게 약을 전달하고 열쇠를 얻으세요."},
        {303, "1학년 교무실에서 교실 열쇠를 훔치세요."},
        {304, "남은 1학년 교실들을 구석구석, 꼼꼼히 탐방하세요."},
        {305, "전산실 열쇠 조각을 찾으세요. (1)"},
        {306, "전산실 열쇠 조각을 찾으세요. (2)"},
        {307, "전산실 열쇠 조각을 찾으세요. (3)"},
