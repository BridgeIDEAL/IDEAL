...
public class RoomArchiveLogData
{
    ...
    public void GenerateDictionary(){
        ...
        roomArchiveDictionary.Add(0402, "<u><b>$attempts차 추가. 교장이 추격해올 경우 따돌리는 용도로 사용 가능한 것을 확인.</b></u>");
        ...
        roomArchiveDictionary.Add(0602, "<u><b>$attempts차 추가. 굉장히 편안하고 아늑한 공간이다.</b></u>");
        ...
        roomArchiveDictionary.Add(1302, "<b>$attempts차: 1층 교무실에 선생님이 있을 경우 주의 필요</b>");
        roomArchiveDictionary.Add(1303, "<b>$attempts차: 2층 교무실은 현재 끌려가는 방식으로만 진입 가능한 것으로 추정.</b>");
